        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Add a pharmaceutical item to active inventory</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm font-mono border border-slate-200 rounded-lg focus:outline-hidden focus:border-sky-500"
              />
            </div>
          </div>
