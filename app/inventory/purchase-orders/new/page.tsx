  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2 text-xs font-medium text-slate-500">
        ...
        <span>&gt;</span>
        <Link href="/inventory/suppliers" className="hover:text-sky-600">
          Suppliers
        </Link>
        <span>&gt;</span>
        <span className="text-slate-700 font-semibold">New PO</span>
      </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 text-xs sm:text-sm font-semibold text-slate-700 bg-white border border-slate-300 hover:bg-slate-50 rounded-lg transition-colors shadow-2xs"
          >
            Save as Draft
          </button>
          <button
        ...
        <div className="lg:col-span-8 space-y-6">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-xs sm:text-sm rounded-lg border border-slate-200 bg-white text-slate-800 focus:outline-hidden focus:border-sky-500 font-medium"
                >
          ...
          <div className="bg-white rounded-xl border border-slate-200/90 p-6 shadow-2xs space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 text-xs rounded-lg border border-slate-200 text-slate-700 placeholder-slate-400 focus:outline-hidden focus:border-sky-500"
                />

                {/* Search Dropdown */}
                {searchProductQuery.trim() && (
                  <div className="absolute left-0 right-0 top-full mt-1 bg-white rounded-lg border border-slate-200 shadow-lg z-20 max-h-48 overflow-y-auto divide-y divide-slate-100">
                      ...
                      return (
                        <tr key={item.id} className="hover:bg-slate-50/50">
                          ...
                          <td className="py-3 px-4">
                            ...
                            <div className="text-[10.5px] font-mono text-slate-400 uppercase">
                              SKU: {item.sku}
                            </div>
                          </td>
                          ...
                          <td className="py-3 px-4 text-center">
                            <input
                              ...
                              className="w-20 px-2.5 py-1 text-center font-mono font-bold text-slate-800 border border-slate-200 rounded-md focus:border-sky-500 focus:outline-hidden"
                            />
                          </td>
            ...
            <button
              ...
              className="w-full py-2.5 border-2 border-dashed border-slate-200 hover:border-sky-400 hover:bg-sky-50/50 rounded-xl text-xs sm:text-sm font-semibold text-[#006699] flex items-center justify-center gap-2 transition-all"
            >
            ...
            <div className="space-y-3.5">
              ...
              <div>
                ...
                <input
                  ...
                  disabled
                  value={poNumber}
                  className="w-full px-3 py-2 text-xs sm:text-sm font-mono font-medium rounded-lg border border-slate-200 bg-slate-100/80 text-slate-600 cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs sm:text-sm rounded-lg border border-slate-200 bg-white text-slate-800 focus:outline-hidden focus:border-sky-500"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-xs sm:text-sm rounded-lg border border-slate-200 bg-white text-slate-800 focus:outline-hidden focus:border-sky-500 font-medium"
                >
