      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Monitor and mitigate upcoming medication expirations.
          </p>
        </div>
                  ...
                  <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                    ...
                    <td className="py-3.5 px-6 text-right">
                      ...
                      {item.actionType === "return" && (
                        <button
                          onClick={() => handleAction(item)}
                          className="inline-flex items-center gap-1 text-xs font-semibold text-sky-600 hover:text-sky-800 hover:bg-sky-50 px-2.5 py-1 rounded-lg transition-colors"
                        >
                      ...
                      {item.actionType === "monitor" && (
                        <button
                          onClick={() => handleAction(item)}
                          className="inline-flex items-center gap-1 text-xs font-semibold text-slate-600 hover:text-slate-800 hover:bg-slate-100 px-2.5 py-1 rounded-lg transition-colors"
                        >
